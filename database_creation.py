...
query = """-- Schema basketball_reference
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `basketball_reference` DEFAULT CHARACTER SET utf8 ;
USE `basketball_reference` ;

-- -----------------------------------------------------
-- Table `basketball_reference`.`players`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`teams`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `basketball_reference`.`teams` (
  `team_id` INT NOT NULL AUTO_INCREMENT,
  `team_name` VARCHAR(3) NULL,
  PRIMARY KEY (`team_id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `basketball_reference`.`rosters`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`salaries`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`players_stats`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`teams_summaries`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`teams_stats`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`teams_ranks`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`boxscores`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`games`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`players_rosters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `basketball_reference`.`players_rosters` (
  `player_id` INT NOT NULL,
  `roster_id` INT NOT NULL,
  PRIMARY KEY (`player_id`, `roster_id`),
  INDEX `fk_players_has_rosters_rosters1_idx` (`roster_id` ASC) VISIBLE,
  INDEX `fk_players_has_rosters_players_idx` (`player_id` ASC) VISIBLE,
  CONSTRAINT `fk_players_has_rosters_players`
    FOREIGN KEY (`player_id`)
    REFERENCES `basketball_reference`.`players` (`player_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_players_has_rosters_rosters1`
    FOREIGN KEY (`roster_id`)
    REFERENCES `basketball_reference`.`rosters` (`roster_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `basketball_reference`.`players_boxscores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `basketball_reference`.`players_boxscores` (
  `player_id` INT NOT NULL,
  `boxscore_id` INT NOT NULL,
  PRIMARY KEY (`player_id`, `boxscore_id`),
  INDEX `fk_players_has_boxscores_boxscores1_idx` (`boxscore_id` ASC) VISIBLE,
  INDEX `fk_players_has_boxscores_players1_idx` (`player_id` ASC) VISIBLE,
  CONSTRAINT `fk_players_has_boxscores_players1`
    FOREIGN KEY (`player_id`)
    REFERENCES `basketball_reference`.`players` (`player_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_players_has_boxscores_boxscores1`
    FOREIGN KEY (`boxscore_id`)
    REFERENCES `basketball_reference`.`boxscores` (`boxscore_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;"""
